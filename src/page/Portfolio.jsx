  ...
  return (
    <div>
        ...
        <div className="mx-40 my-20 text-center ">
            ...
            <p className="text-6xl mt-5 text-[] font-bold uppercase">Desenvolvedor full-stack, apaixonado por tecnologia e por criar soluções que facilitam a vida das pessoas.</p>
        </div>
    </div>
  )
}