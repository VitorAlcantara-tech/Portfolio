...
import Logo from "../assets/logotipo.png"; // ajuste o caminho/nome do arquivo
...
export default function Footer() {
    ...
    return (
        <footer className="w-full mt-20 bg-[#010812] border-t border-white/10">
            <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-col items-start md:items-center gap-2">
                    ...
                    <a
                        onClick={copiarEmail}
                        className="flex items-center gap-2 text-sm text-gray-200 hover:text-[#00FFAA] transition-colors cursor-pointer"
                    >
                    ...
                    {copiado && (
                        <div className="fixed bottom-20 left-1/2 -translate-x-1/2 px-4 py-2 bg-white/20 backdrop-blur 
                text-white rounded-lg animate-fade-in-out">
                    Copiado!
                    </div>
